    ...
    <Box sx={pageShellSx}>
      <Paper elevation={0} sx={getEntryPaperSx}>
        <Box>
          <Typography
            variant="h5"
            sx={{ fontWeight: 700, color: '#0f172a', mb: 1, fontFamily: 'Calibri, Arial, sans-serif' }}
          >
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          ...
          >
            ...
            <Autocomplete
              ...
              renderInput={(params) => <TextField {...params} fullWidth label="Đợt Giao Hàng" />}
...
export default OrderEntryFormClean;
